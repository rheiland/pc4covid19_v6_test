...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        menv_var2 = Button(description='interferon_1 (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var3 = Button(description='pro_inflammatory_cytokine (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var4 = Button(description='chemokine (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var5 = Button(description='debris (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var6 = Button(description='pro_pyroptosis_cytokine (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var9 = Button(description='Ig (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        menv_var10 = Button(description='ROS (mol/micron^3)', disabled=True, layout=name_button_layout)
        ...
        row_interferon_1 = [menv_var2,  ] 
        row5 = [param_name5, self.interferon_1_diffusion_coefficient, menv_units_button5]
        row6 = [param_name6, self.interferon_1_decay_rate, menv_units_button6]
        row7 = [param_name7, self.interferon_1_initial_condition, menv_units_button7]
        row8 = [param_name8, self.interferon_1_Dirichlet_boundary_condition, menv_units_button8, self.interferon_1_Dirichlet_boundary_condition_toggle]
        row_pro_inflammatory_cytokine = [menv_var3,  ] 
        row9 = [param_name9, self.pro_inflammatory_cytokine_diffusion_coefficient, menv_units_button9]
        row10 = [param_name10, self.pro_inflammatory_cytokine_decay_rate, menv_units_button10]
        row11 = [param_name11, self.pro_inflammatory_cytokine_initial_condition, menv_units_button11]
        row12 = [param_name12, self.pro_inflammatory_cytokine_Dirichlet_boundary_condition, menv_units_button12, self.pro_inflammatory_cytokine_Dirichlet_boundary_condition_toggle]
        row_chemokine = [menv_var4,  ] 
        row13 = [param_name13, self.chemokine_diffusion_coefficient, menv_units_button13]
        row14 = [param_name14, self.chemokine_decay_rate, menv_units_button14]
        row15 = [param_name15, self.chemokine_initial_condition, menv_units_button15]
        row16 = [param_name16, self.chemokine_Dirichlet_boundary_condition, menv_units_button16, self.chemokine_Dirichlet_boundary_condition_toggle]
        row_debris = [menv_var5,  ] 
        row17 = [param_name17, self.debris_diffusion_coefficient, menv_units_button17]
        row18 = [param_name18, self.debris_decay_rate, menv_units_button18]
        row19 = [param_name19, self.debris_initial_condition, menv_units_button19]
        row20 = [param_name20, self.debris_Dirichlet_boundary_condition, menv_units_button20, self.debris_Dirichlet_boundary_condition_toggle]
        row_pro_pyroptosis_cytokine = [menv_var6,  ] 
        row21 = [param_name21, self.pro_pyroptosis_cytokine_diffusion_coefficient, menv_units_button21]
        row22 = [param_name22, self.pro_pyroptosis_cytokine_decay_rate, menv_units_button22]
        row23 = [param_name23, self.pro_pyroptosis_cytokine_initial_condition, menv_units_button23]
        row24 = [param_name24, self.pro_pyroptosis_cytokine_Dirichlet_boundary_condition, menv_units_button24, self.pro_pyroptosis_cytokine_Dirichlet_boundary_condition_toggle]
        row_anti_inflammatory_cytokine = [menv_var7,  ] 
        row25 = [param_name25, self.anti_inflammatory_cytokine_diffusion_coefficient, menv_units_button25]
        row26 = [param_name26, self.anti_inflammatory_cytokine_decay_rate, menv_units_button26]
        row27 = [param_name27, self.anti_inflammatory_cytokine_initial_condition, menv_units_button27]
        row28 = [param_name28, self.anti_inflammatory_cytokine_Dirichlet_boundary_condition, menv_units_button28, self.anti_inflammatory_cytokine_Dirichlet_boundary_condition_toggle]
        row_collagen = [menv_var8,  ] 
        row29 = [param_name29, self.collagen_diffusion_coefficient, menv_units_button29]
        row30 = [param_name30, self.collagen_decay_rate, menv_units_button30]
        row31 = [param_name31, self.collagen_initial_condition, menv_units_button31]
        row32 = [param_name32, self.collagen_Dirichlet_boundary_condition, menv_units_button32, self.collagen_Dirichlet_boundary_condition_toggle]
        row_Ig = [menv_var9,  ] 
        row33 = [param_name33, self.Ig_diffusion_coefficient, menv_units_button33]
        row34 = [param_name34, self.Ig_decay_rate, menv_units_button34]
        row35 = [param_name35, self.Ig_initial_condition, menv_units_button35]
        row36 = [param_name36, self.Ig_Dirichlet_boundary_condition, menv_units_button36, self.Ig_Dirichlet_boundary_condition_toggle]
        row_ROS = [menv_var10,  ] 
        row37 = [param_name37, self.ROS_diffusion_coefficient, menv_units_button37]
        row38 = [param_name38, self.ROS_decay_rate, menv_units_button38]
        row39 = [param_name39, self.ROS_initial_condition, menv_units_button39]
        row40 = [param_name40, self.ROS_Dirichlet_boundary_condition, menv_units_button40, self.ROS_Dirichlet_boundary_condition_toggle]
        row41 = [self.calculate_gradient,]
        row42 = [self.track_internal,]
    ...
    def fill_gui(self, xml_root):
        ...
        self.interferon_1_diffusion_coefficient.value = float(vp[1].find('.//diffusion_coefficient').text)
        self.interferon_1_decay_rate.value = float(vp[1].find('.//decay_rate').text)
        self.interferon_1_initial_condition.value = float(vp[1].find('.//initial_condition').text)
        self.interferon_1_Dirichlet_boundary_condition.value = float(vp[1].find('.//Dirichlet_boundary_condition').text)
        ...
        self.pro_inflammatory_cytokine_diffusion_coefficient.value = float(vp[2].find('.//diffusion_coefficient').text)
        self.pro_inflammatory_cytokine_decay_rate.value = float(vp[2].find('.//decay_rate').text)
        self.pro_inflammatory_cytokine_initial_condition.value = float(vp[2].find('.//initial_condition').text)
        self.pro_inflammatory_cytokine_Dirichlet_boundary_condition.value = float(vp[2].find('.//Dirichlet_boundary_condition').text)
        ...
        self.chemokine_diffusion_coefficient.value = float(vp[3].find('.//diffusion_coefficient').text)
        self.chemokine_decay_rate.value = float(vp[3].find('.//decay_rate').text)
        self.chemokine_initial_condition.value = float(vp[3].find('.//initial_condition').text)
        self.chemokine_Dirichlet_boundary_condition.value = float(vp[3].find('.//Dirichlet_boundary_condition').text)
        ...
        self.debris_diffusion_coefficient.value = float(vp[4].find('.//diffusion_coefficient').text)
        self.debris_decay_rate.value = float(vp[4].find('.//decay_rate').text)
        self.debris_initial_condition.value = float(vp[4].find('.//initial_condition').text)
        self.debris_Dirichlet_boundary_condition.value = float(vp[4].find('.//Dirichlet_boundary_condition').text)
        ...
        self.pro_pyroptosis_cytokine_diffusion_coefficient.value = float(vp[5].find('.//diffusion_coefficient').text)
        self.pro_pyroptosis_cytokine_decay_rate.value = float(vp[5].find('.//decay_rate').text)
        self.pro_pyroptosis_cytokine_initial_condition.value = float(vp[5].find('.//initial_condition').text)
        self.pro_pyroptosis_cytokine_Dirichlet_boundary_condition.value = float(vp[5].find('.//Dirichlet_boundary_condition').text)
        ...
        self.anti_inflammatory_cytokine_diffusion_coefficient.value = float(vp[6].find('.//diffusion_coefficient').text)
        self.anti_inflammatory_cytokine_decay_rate.value = float(vp[6].find('.//decay_rate').text)
        self.anti_inflammatory_cytokine_initial_condition.value = float(vp[6].find('.//initial_condition').text)
        self.anti_inflammatory_cytokine_Dirichlet_boundary_condition.value = float(vp[6].find('.//Dirichlet_boundary_condition').text)
        ...
        self.collagen_diffusion_coefficient.value = float(vp[7].find('.//diffusion_coefficient').text)
        self.collagen_decay_rate.value = float(vp[7].find('.//decay_rate').text)
        self.collagen_initial_condition.value = float(vp[7].find('.//initial_condition').text)
        self.collagen_Dirichlet_boundary_condition.value = float(vp[7].find('.//Dirichlet_boundary_condition').text)
        ...
        self.Ig_diffusion_coefficient.value = float(vp[8].find('.//diffusion_coefficient').text)
        self.Ig_decay_rate.value = float(vp[8].find('.//decay_rate').text)
        self.Ig_initial_condition.value = float(vp[8].find('.//initial_condition').text)
        self.Ig_Dirichlet_boundary_condition.value = float(vp[8].find('.//Dirichlet_boundary_condition').text)
        ...
        self.ROS_diffusion_coefficient.value = float(vp[9].find('.//diffusion_coefficient').text)
        self.ROS_decay_rate.value = float(vp[9].find('.//decay_rate').text)
        self.ROS_initial_condition.value = float(vp[9].find('.//initial_condition').text)
        self.ROS_Dirichlet_boundary_condition.value = float(vp[9].find('.//Dirichlet_boundary_condition').text)
    ...
    def fill_xml(self, xml_root):
        ...
        vp[1].find('.//diffusion_coefficient').text = str(self.interferon_1_diffusion_coefficient.value)
        vp[1].find('.//decay_rate').text = str(self.interferon_1_decay_rate.value)
        vp[1].find('.//initial_condition').text = str(self.interferon_1_initial_condition.value)
        vp[1].find('.//Dirichlet_boundary_condition').text = str(self.interferon_1_Dirichlet_boundary_condition.value)
        vp[1].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.interferon_1_Dirichlet_boundary_condition_toggle.value).lower()

        vp[2].find('.//diffusion_coefficient').text = str(self.pro_inflammatory_cytokine_diffusion_coefficient.value)
        vp[2].find('.//decay_rate').text = str(self.pro_inflammatory_cytokine_decay_rate.value)
        vp[2].find('.//initial_condition').text = str(self.pro_inflammatory_cytokine_initial_condition.value)
        vp[2].find('.//Dirichlet_boundary_condition').text = str(self.pro_inflammatory_cytokine_Dirichlet_boundary_condition.value)
        vp[2].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.pro_inflammatory_cytokine_Dirichlet_boundary_condition_toggle.value).lower()

        vp[3].find('.//diffusion_coefficient').text = str(self.chemokine_diffusion_coefficient.value)
        vp[3].find('.//decay_rate').text = str(self.chemokine_decay_rate.value)
        vp[3].find('.//initial_condition').text = str(self.chemokine_initial_condition.value)
        vp[3].find('.//Dirichlet_boundary_condition').text = str(self.chemokine_Dirichlet_boundary_condition.value)
        vp[3].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.chemokine_Dirichlet_boundary_condition_toggle.value).lower()

        vp[4].find('.//diffusion_coefficient').text = str(self.debris_diffusion_coefficient.value)
        vp[4].find('.//decay_rate').text = str(self.debris_decay_rate.value)
        vp[4].find('.//initial_condition').text = str(self.debris_initial_condition.value)
        vp[4].find('.//Dirichlet_boundary_condition').text = str(self.debris_Dirichlet_boundary_condition.value)
        vp[4].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.debris_Dirichlet_boundary_condition_toggle.value).lower()

        vp[5].find('.//diffusion_coefficient').text = str(self.pro_pyroptosis_cytokine_diffusion_coefficient.value)
        vp[5].find('.//decay_rate').text = str(self.pro_pyroptosis_cytokine_decay_rate.value)
        vp[5].find('.//initial_condition').text = str(self.pro_pyroptosis_cytokine_initial_condition.value)
        vp[5].find('.//Dirichlet_boundary_condition').text = str(self.pro_pyroptosis_cytokine_Dirichlet_boundary_condition.value)
        vp[5].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.pro_pyroptosis_cytokine_Dirichlet_boundary_condition_toggle.value).lower()

        vp[6].find('.//diffusion_coefficient').text = str(self.anti_inflammatory_cytokine_diffusion_coefficient.value)
        vp[6].find('.//decay_rate').text = str(self.anti_inflammatory_cytokine_decay_rate.value)
        vp[6].find('.//initial_condition').text = str(self.anti_inflammatory_cytokine_initial_condition.value)
        vp[6].find('.//Dirichlet_boundary_condition').text = str(self.anti_inflammatory_cytokine_Dirichlet_boundary_condition.value)
        vp[6].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.anti_inflammatory_cytokine_Dirichlet_boundary_condition_toggle.value).lower()

        vp[7].find('.//diffusion_coefficient').text = str(self.collagen_diffusion_coefficient.value)
        vp[7].find('.//decay_rate').text = str(self.collagen_decay_rate.value)
        vp[7].find('.//initial_condition').text = str(self.collagen_initial_condition.value)
        vp[7].find('.//Dirichlet_boundary_condition').text = str(self.collagen_Dirichlet_boundary_condition.value)
        vp[7].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.collagen_Dirichlet_boundary_condition_toggle.value).lower()

        vp[8].find('.//diffusion_coefficient').text = str(self.Ig_diffusion_coefficient.value)
        vp[8].find('.//decay_rate').text = str(self.Ig_decay_rate.value)
        vp[8].find('.//initial_condition').text = str(self.Ig_initial_condition.value)
        vp[8].find('.//Dirichlet_boundary_condition').text = str(self.Ig_Dirichlet_boundary_condition.value)
        vp[8].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.Ig_Dirichlet_boundary_condition_toggle.value).lower()

        vp[9].find('.//diffusion_coefficient').text = str(self.ROS_diffusion_coefficient.value)
        vp[9].find('.//decay_rate').text = str(self.ROS_decay_rate.value)
        vp[9].find('.//initial_condition').text = str(self.ROS_initial_condition.value)
        vp[9].find('.//Dirichlet_boundary_condition').text = str(self.ROS_Dirichlet_boundary_condition.value)
        vp[9].find('.//Dirichlet_boundary_condition').attrib['enabled'] = str(self.ROS_Dirichlet_boundary_condition_toggle.value).lower()
