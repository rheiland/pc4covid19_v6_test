...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name42 = Button(description='Death_rates_of_old_Tcells', disabled=True, layout=name_button_layout)
        ...
        param_name43 = Button(description='RNA_lower_bound', disabled=True, layout=name_button_layout)
        ...
        param_name44 = Button(description='fibroblast_max_recruitment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name45 = Button(description='fibroblast_recruitment_min_signal', disabled=True, layout=name_button_layout)
        ...
        param_name46 = Button(description='fibroblast_recruitment_saturation_signal', disabled=True, layout=name_button_layout)
        ...
        param_name47 = Button(description='multiplicity_of_infection', disabled=True, layout=name_button_layout)
        ...
        param_name48 = Button(description='use_single_infected_cell', disabled=True, layout=name_button_layout)
        ...
        param_name49 = Button(description='use_uniform_dist', disabled=True, layout=name_button_layout)
        ...
        param_name51 = Button(description='number_of_macrophages', disabled=True, layout=name_button_layout)
        ...
        param_name52 = Button(description='number_of_neutrophils', disabled=True, layout=name_button_layout)
        ...
        param_name53 = Button(description='number_of_fibroblast', disabled=True, layout=name_button_layout)
        ...
        param_name54 = Button(description='number_of_DCs', disabled=True, layout=name_button_layout)
        ...
        param_name55 = Button(description='number_of_CD4_Tcells', disabled=True, layout=name_button_layout)
        ...
        param_name56 = Button(description='DC_induced_CD8_proliferation', disabled=True, layout=name_button_layout)
        ...
        param_name57 = Button(description='DC_induced_CD8_attachment', disabled=True, layout=name_button_layout)
        ...
        param_name58 = Button(description='departure_rate_of_DCs', disabled=True, layout=name_button_layout)
        ...
        param_name59 = Button(description='virions_needed_for_DC_activation', disabled=True, layout=name_button_layout)
        ...
        param_name60 = Button(description='epsilon_distance', disabled=True, layout=name_button_layout)
        ...
        param_name61 = Button(description='perecentage_tissue_vascularized', disabled=True, layout=name_button_layout)
        ...
        param_name62 = Button(description='color_variable', disabled=True, layout=name_button_layout)
        ...
        param_name63 = Button(description='epithelial_opacity', disabled=True, layout=name_button_layout)
        ...
        param_name64 = Button(description='non_epithelial_opacity', disabled=True, layout=name_button_layout)
        ...
        param_name65 = Button(description='apoptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name66 = Button(description='apoptotic_immune_color', disabled=True, layout=name_button_layout)
        ...
        param_name67 = Button(description='pyroptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name68 = Button(description='pyroptotic_bystander_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name69 = Button(description='vi_apoptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name70 = Button(description='CD8_Tcell_color', disabled=True, layout=name_button_layout)
        ...
        param_name71 = Button(description='CD4_Tcell_color', disabled=True, layout=name_button_layout)
        ...
        param_name72 = Button(description='Macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name73 = Button(description='activated_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name74 = Button(description='exhausted_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name75 = Button(description='hyperactivated_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name76 = Button(description='Neutrophil_color', disabled=True, layout=name_button_layout)
        ...
        param_name77 = Button(description='DC_color', disabled=True, layout=name_button_layout)
        ...
        param_name78 = Button(description='activated_DC_color', disabled=True, layout=name_button_layout)
        ...
        param_name79 = Button(description='fibroblast_color', disabled=True, layout=name_button_layout)
        ...
        param_name80 = Button(description='phagocytes_virus_uptake_rate', disabled=True, layout=name_button_layout)
        ...
        param_name81 = Button(description='ROS_secretion_rate', disabled=True, layout=name_button_layout)
        ...
        param_name82 = Button(description='epsilon_ROS', disabled=True, layout=name_button_layout)
        ...
        param_name83 = Button(description='Antibody_binding_rate', disabled=True, layout=name_button_layout)
        ...
        param_name84 = Button(description='antibody_half_effect', disabled=True, layout=name_button_layout)
        ...
        param_name85 = Button(description='virus_fraction_released_at_death', disabled=True, layout=name_button_layout)
        ...
        units_button45 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button61 = Button(description='virions', disabled=True, layout=units_button_layout) 
        ...
        units_button63 = Button(description='percentage', disabled=True, layout=units_button_layout) 
        ...
        desc_button42 = Button(description='value to kill T Cells post generation limit' , tooltip='value to kill T Cells post generation limit', disabled=True, layout=desc_button_layout) 
        desc_button42.style.button_color = 'tan'
        desc_button43 = Button(description='lowest value to start probability draws for pyroptosis' , tooltip='lowest value to start probability draws for pyroptosis', disabled=True, layout=desc_button_layout) 
        desc_button43.style.button_color = 'lightgreen'
        desc_button44 = Button(description='max fibroblast cell recruitment rate (for saturated signal)' , tooltip='max fibroblast cell recruitment rate (for saturated signal)', disabled=True, layout=desc_button_layout) 
        desc_button44.style.button_color = 'tan'
        desc_button45 = Button(description='min concentration to attract fibroblast cells' , tooltip='min concentration to attract fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button45.style.button_color = 'lightgreen'
        desc_button46 = Button(description='saturating concentration to attract fibroblast cells' , tooltip='saturating concentration to attract fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button46.style.button_color = 'tan'
        desc_button47 = Button(description='multiplicity of infection: virions/cells at t=0' , tooltip='multiplicity of infection: virions/cells at t=0', disabled=True, layout=desc_button_layout) 
        desc_button47.style.button_color = 'lightgreen'
        desc_button48 = Button(description='Infect center cell with one virion (overrides MOI)' , tooltip='Infect center cell with one virion (overrides MOI)', disabled=True, layout=desc_button_layout) 
        desc_button48.style.button_color = 'tan'
        desc_button49 = Button(description='use a uniform distribution' , tooltip='use a uniform distribution', disabled=True, layout=desc_button_layout) 
        desc_button49.style.button_color = 'lightgreen'
        desc_button50 = Button(description='initial number of CD8 T cells in tissue' , tooltip='initial number of CD8 T cells in tissue', disabled=True, layout=desc_button_layout) 
        desc_button50.style.button_color = 'tan'
        desc_button51 = Button(description='initial number of macrophages' , tooltip='initial number of macrophages', disabled=True, layout=desc_button_layout) 
        desc_button51.style.button_color = 'lightgreen'
        desc_button52 = Button(description='initial number of neutrophils' , tooltip='initial number of neutrophils', disabled=True, layout=desc_button_layout) 
        desc_button52.style.button_color = 'tan'
        desc_button53 = Button(description='initial number of fibroblast cells' , tooltip='initial number of fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button53.style.button_color = 'lightgreen'
        desc_button54 = Button(description='initial number of Dendritic Cells' , tooltip='initial number of Dendritic Cells', disabled=True, layout=desc_button_layout) 
        desc_button54.style.button_color = 'tan'
        desc_button55 = Button(description='initial number of CD4 Tcells in tissue' , tooltip='initial number of CD4 Tcells in tissue', disabled=True, layout=desc_button_layout) 
        desc_button55.style.button_color = 'lightgreen'
        desc_button56 = Button(description='DC induced CD8 proliferation rate' , tooltip='DC induced CD8 proliferation rate', disabled=True, layout=desc_button_layout) 
        desc_button56.style.button_color = 'tan'
        desc_button57 = Button(description='DC induced CD8 attachement rate' , tooltip='DC induced CD8 attachement rate', disabled=True, layout=desc_button_layout) 
        desc_button57.style.button_color = 'lightgreen'
        desc_button58 = Button(description='Departure rate of activated DCs' , tooltip='Departure rate of activated DCs', disabled=True, layout=desc_button_layout) 
        ...
        desc_button61 = Button(description='percentage of tissue sitting above blood vessels' , tooltip='percentage of tissue sitting above blood vessels', disabled=True, layout=desc_button_layout) 
        desc_button61.style.button_color = 'lightgreen'
        desc_button62 = Button(description='color cells based on this variable' , tooltip='color cells based on this variable', disabled=True, layout=desc_button_layout) 
        desc_button62.style.button_color = 'tan'
        desc_button63 = Button(description='opacity of epithelial cells' , tooltip='opacity of epithelial cells', disabled=True, layout=desc_button_layout) 
        desc_button63.style.button_color = 'lightgreen'
        desc_button64 = Button(description='opacity of non-epithelial cells' , tooltip='opacity of non-epithelial cells', disabled=True, layout=desc_button_layout) 
        desc_button64.style.button_color = 'tan'
        desc_button65 = Button(description='apoptotic epithelial cell color' , tooltip='apoptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button65.style.button_color = 'lightgreen'
        desc_button66 = Button(description='apoptotic immune cell color' , tooltip='apoptotic immune cell color', disabled=True, layout=desc_button_layout) 
        ...
        desc_button69 = Button(description='pyroptotic epithelial cell color' , tooltip='pyroptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button69.style.button_color = 'lightgreen'
        desc_button70 = Button(description='CD8 T cell color' , tooltip='CD8 T cell color', disabled=True, layout=desc_button_layout) 
        desc_button70.style.button_color = 'tan'
        desc_button71 = Button(description='CD4 T cell color' , tooltip='CD4 T cell color', disabled=True, layout=desc_button_layout) 
        desc_button71.style.button_color = 'lightgreen'
        desc_button72 = Button(description='macrophage color' , tooltip='macrophage color', disabled=True, layout=desc_button_layout) 
        desc_button72.style.button_color = 'tan'
        desc_button73 = Button(description='color of activated macrophage' , tooltip='color of activated macrophage', disabled=True, layout=desc_button_layout) 
        desc_button73.style.button_color = 'lightgreen'
        desc_button74 = Button(description='color of exhausted macrophage' , tooltip='color of exhausted macrophage', disabled=True, layout=desc_button_layout) 
        desc_button74.style.button_color = 'tan'
        desc_button75 = Button(description='color of hyperactivated macrophage' , tooltip='color of hyperactivated macrophage', disabled=True, layout=desc_button_layout) 
        desc_button75.style.button_color = 'lightgreen'
        desc_button76 = Button(description='neutrophil color' , tooltip='neutrophil color', disabled=True, layout=desc_button_layout) 
        ...
        desc_button78 = Button(description='DC color' , tooltip='DC color', disabled=True, layout=desc_button_layout) 
        desc_button78.style.button_color = 'tan'
        desc_button79 = Button(description='fibroblast cell color' , tooltip='fibroblast cell color', disabled=True, layout=desc_button_layout) 
        desc_button79.style.button_color = 'lightgreen'
        desc_button80 = Button(description='Rate that phagocytes uptake virus after activation' , tooltip='Rate that phagocytes uptake virus after activation', disabled=True, layout=desc_button_layout) 
        desc_button80.style.button_color = 'tan'
        desc_button81 = Button(description='Rate that neutrophils secrete ROS' , tooltip='Rate that neutrophils secrete ROS', disabled=True, layout=desc_button_layout) 
        desc_button81.style.button_color = 'lightgreen'
        desc_button82 = Button(description='ROS half-effect' , tooltip='ROS half-effect', disabled=True, layout=desc_button_layout) 
        desc_button82.style.button_color = 'tan'
        desc_button83 = Button(description='Binding rate of antibody to infected cells' , tooltip='Binding rate of antibody to infected cells', disabled=True, layout=desc_button_layout) 
        desc_button83.style.button_color = 'lightgreen'
        desc_button84 = Button(description='Half effect of antibody on macrophage phagocytosis' , tooltip='Half effect of antibody on macrophage phagocytosis', disabled=True, layout=desc_button_layout) 
        desc_button84.style.button_color = 'tan'
        desc_button85 = Button(description='fraction of internal virus released at cell death' , tooltip='fraction of internal virus released at cell death', disabled=True, layout=desc_button_layout) 
        ...
        row42 = [param_name42, self.Death_rates_of_old_Tcells, units_button43, desc_button42] 
        row43 = [param_name43, self.RNA_lower_bound, units_button44, desc_button43] 
        row44 = [param_name44, self.fibroblast_max_recruitment_rate, units_button45, desc_button44] 
        row45 = [param_name45, self.fibroblast_recruitment_min_signal, units_button46, desc_button45] 
        row46 = [param_name46, self.fibroblast_recruitment_saturation_signal, units_button47, desc_button46] 
        row47 = [param_name47, self.multiplicity_of_infection, units_button49, desc_button47] 
        row48 = [param_name48, self.use_single_infected_cell, units_button50, desc_button48] 
        row49 = [param_name49, self.use_uniform_dist, units_button51, desc_button49] 
        row50 = [param_name50, self.number_of_CD8_Tcells, units_button52, desc_button50] 
        row51 = [param_name51, self.number_of_macrophages, units_button53, desc_button51] 
        row52 = [param_name52, self.number_of_neutrophils, units_button54, desc_button52] 
        row53 = [param_name53, self.number_of_fibroblast, units_button55, desc_button53] 
        row54 = [param_name54, self.number_of_DCs, units_button56, desc_button54] 
        row55 = [param_name55, self.number_of_CD4_Tcells, units_button57, desc_button55] 
        row56 = [param_name56, self.DC_induced_CD8_proliferation, units_button58, desc_button56] 
        row57 = [param_name57, self.DC_induced_CD8_attachment, units_button59, desc_button57] 
        row58 = [param_name58, self.departure_rate_of_DCs, units_button60, desc_button58] 
        row59 = [param_name59, self.virions_needed_for_DC_activation, units_button61, desc_button59] 
        row60 = [param_name60, self.epsilon_distance, units_button62, desc_button60] 
        row61 = [param_name61, self.perecentage_tissue_vascularized, units_button63, desc_button61] 
        row62 = [param_name62, self.color_variable, units_button65, desc_button62] 
        row63 = [param_name63, self.epithelial_opacity, units_button66, desc_button63] 
        row64 = [param_name64, self.non_epithelial_opacity, units_button67, desc_button64] 
        row65 = [param_name65, self.apoptotic_epithelium_color, units_button68, desc_button65] 
        row66 = [param_name66, self.apoptotic_immune_color, units_button69, desc_button66] 
        row67 = [param_name67, self.pyroptotic_epithelium_color, units_button70, desc_button67] 
        row68 = [param_name68, self.pyroptotic_bystander_epithelium_color, units_button71, desc_button68] 
        row69 = [param_name69, self.vi_apoptotic_epithelium_color, units_button72, desc_button69] 
        row70 = [param_name70, self.CD8_Tcell_color, units_button73, desc_button70] 
        row71 = [param_name71, self.CD4_Tcell_color, units_button74, desc_button71] 
        row72 = [param_name72, self.Macrophage_color, units_button75, desc_button72] 
        row73 = [param_name73, self.activated_macrophage_color, units_button76, desc_button73] 
        row74 = [param_name74, self.exhausted_macrophage_color, units_button77, desc_button74] 
        row75 = [param_name75, self.hyperactivated_macrophage_color, units_button78, desc_button75] 
        row76 = [param_name76, self.Neutrophil_color, units_button79, desc_button76] 
        row77 = [param_name77, self.DC_color, units_button80, desc_button77] 
        row78 = [param_name78, self.activated_DC_color, units_button81, desc_button78] 
        row79 = [param_name79, self.fibroblast_color, units_button82, desc_button79] 
        row80 = [param_name80, self.phagocytes_virus_uptake_rate, units_button83, desc_button80] 
        row81 = [param_name81, self.ROS_secretion_rate, units_button84, desc_button81] 
        row82 = [param_name82, self.epsilon_ROS, units_button85, desc_button82] 
        row83 = [param_name83, self.Antibody_binding_rate, units_button86, desc_button83] 
        row84 = [param_name84, self.antibody_half_effect, units_button87, desc_button84] 
        row85 = [param_name85, self.virus_fraction_released_at_death, units_button88, desc_button85] 
