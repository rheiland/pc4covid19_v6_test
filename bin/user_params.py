...
class UserTab(object):
    ...
    def __init__(self):
        ...
        param_name2 = Button(description='immune_z_offset', disabled=True, layout=name_button_layout)
        ...
        param_name3 = Button(description='macrophage_max_recruitment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name4 = Button(description='macrophage_recruitment_min_signal', disabled=True, layout=name_button_layout)
        ...
        param_name5 = Button(description='macrophage_recruitment_saturation_signal', disabled=True, layout=name_button_layout)
        ...
        param_name6 = Button(description='neutrophil_max_recruitment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name7 = Button(description='neutrophil_recruitment_min_signal', disabled=True, layout=name_button_layout)
        ...
        param_name8 = Button(description='neutrophil_recruitment_saturation_signal', disabled=True, layout=name_button_layout)
        ...
        param_name9 = Button(description='DC_max_recruitment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name10 = Button(description='DC_recruitment_min_signal', disabled=True, layout=name_button_layout)
        ...
        param_name11 = Button(description='DC_recruitment_saturation_signal', disabled=True, layout=name_button_layout)
        ...
        param_name12 = Button(description='TC_death_rate', disabled=True, layout=name_button_layout)
        ...
        param_name13 = Button(description='max_activation_TC', disabled=True, layout=name_button_layout)
        ...
        param_name14 = Button(description='half_max_activation_TC', disabled=True, layout=name_button_layout)
        ...
        param_name15 = Button(description='max_clearance_TC', disabled=True, layout=name_button_layout)
        ...
        param_name16 = Button(description='half_max_clearance_TC', disabled=True, layout=name_button_layout)
        ...
        param_name17 = Button(description='TC_population_threshold', disabled=True, layout=name_button_layout)
        ...
        param_name18 = Button(description='T_Cell_Recruitment', disabled=True, layout=name_button_layout)
        ...
        param_name19 = Button(description='transport_ratio', disabled=True, layout=name_button_layout)
        ...
        param_name20 = Button(description='DM_decay', disabled=True, layout=name_button_layout)
        ...
        param_name21 = Button(description='Th1_max_activation', disabled=True, layout=name_button_layout)
        ...
        param_name22 = Button(description='Th1_damping', disabled=True, layout=name_button_layout)
        ...
        param_name23 = Button(description='Th1_decay', disabled=True, layout=name_button_layout)
        ...
        param_name24 = Button(description='Th_base_decay', disabled=True, layout=name_button_layout)
        ...
        param_name25 = Button(description='Th2_self_feeback', disabled=True, layout=name_button_layout)
        ...
        param_name26 = Button(description='Th2_max_conversion', disabled=True, layout=name_button_layout)
        ...
        param_name27 = Button(description='BCell_removal', disabled=True, layout=name_button_layout)
        ...
        param_name28 = Button(description='BCell_activation', disabled=True, layout=name_button_layout)
        ...
        param_name29 = Button(description='BCell_activation_half', disabled=True, layout=name_button_layout)
        ...
        param_name30 = Button(description='BCell_DC_proliferation', disabled=True, layout=name_button_layout)
        ...
        param_name31 = Button(description='BCell_Th2_wieght_function', disabled=True, layout=name_button_layout)
        ...
        param_name32 = Button(description='BCell_damping', disabled=True, layout=name_button_layout)
        ...
        param_name33 = Button(description='PCell_recuitment', disabled=True, layout=name_button_layout)
        ...
        param_name34 = Button(description='PCell_degradation', disabled=True, layout=name_button_layout)
        ...
        param_name35 = Button(description='Ig_recuitment', disabled=True, layout=name_button_layout)
        ...
        param_name36 = Button(description='Ig_degradation', disabled=True, layout=name_button_layout)
        ...
        param_name37 = Button(description='DC_leave_prob', disabled=True, layout=name_button_layout)
        ...
        param_name38 = Button(description='TC_activation', disabled=True, layout=name_button_layout)
        ...
        param_name39 = Button(description='TC_activation_half', disabled=True, layout=name_button_layout)
        ...
        param_name40 = Button(description='Th_half', disabled=True, layout=name_button_layout)
        ...
        param_name41 = Button(description='Death_rates_of_old_Tcells', disabled=True, layout=name_button_layout)
        ...
        param_name42 = Button(description='RNA_lower_bound', disabled=True, layout=name_button_layout)
        ...
        param_name43 = Button(description='fibroblast_max_recruitment_rate', disabled=True, layout=name_button_layout)
        ...
        param_name44 = Button(description='fibroblast_recruitment_min_signal', disabled=True, layout=name_button_layout)
        ...
        param_name45 = Button(description='fibroblast_recruitment_saturation_signal', disabled=True, layout=name_button_layout)
        ...
        param_name46 = Button(description='multiplicity_of_infection', disabled=True, layout=name_button_layout)
        ...
        param_name47 = Button(description='use_single_infected_cell', disabled=True, layout=name_button_layout)
        ...
        param_name48 = Button(description='use_uniform_dist', disabled=True, layout=name_button_layout)
        ...
        param_name49 = Button(description='number_of_CD8_Tcells', disabled=True, layout=name_button_layout)
        ...
        param_name50 = Button(description='number_of_macrophages', disabled=True, layout=name_button_layout)
        ...
        param_name51 = Button(description='number_of_neutrophils', disabled=True, layout=name_button_layout)
        ...
        param_name52 = Button(description='number_of_fibroblast', disabled=True, layout=name_button_layout)
        ...
        param_name53 = Button(description='number_of_DCs', disabled=True, layout=name_button_layout)
        ...
        param_name54 = Button(description='number_of_CD4_Tcells', disabled=True, layout=name_button_layout)
        ...
        param_name55 = Button(description='DC_induced_CD8_proliferation', disabled=True, layout=name_button_layout)
        ...
        param_name56 = Button(description='DC_induced_CD8_attachment', disabled=True, layout=name_button_layout)
        ...
        param_name57 = Button(description='departure_rate_of_DCs', disabled=True, layout=name_button_layout)
        ...
        param_name58 = Button(description='virions_needed_for_DC_activation', disabled=True, layout=name_button_layout)
        ...
        param_name59 = Button(description='epsilon_distance', disabled=True, layout=name_button_layout)
        ...
        param_name60 = Button(description='perecentage_tissue_vascularized', disabled=True, layout=name_button_layout)
        ...
        param_name61 = Button(description='color_variable', disabled=True, layout=name_button_layout)
        ...
        param_name62 = Button(description='epithelial_opacity', disabled=True, layout=name_button_layout)
        ...
        param_name63 = Button(description='non_epithelial_opacity', disabled=True, layout=name_button_layout)
        ...
        param_name64 = Button(description='apoptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name65 = Button(description='apoptotic_immune_color', disabled=True, layout=name_button_layout)
        ...
        param_name66 = Button(description='pyroptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name67 = Button(description='pyroptotic_bystander_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name68 = Button(description='vi_apoptotic_epithelium_color', disabled=True, layout=name_button_layout)
        ...
        param_name69 = Button(description='CD8_Tcell_color', disabled=True, layout=name_button_layout)
        ...
        param_name70 = Button(description='CD4_Tcell_color', disabled=True, layout=name_button_layout)
        ...
        param_name71 = Button(description='Macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name72 = Button(description='activated_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name73 = Button(description='exhausted_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name74 = Button(description='hyperactivated_macrophage_color', disabled=True, layout=name_button_layout)
        ...
        param_name75 = Button(description='Neutrophil_color', disabled=True, layout=name_button_layout)
        ...
        param_name76 = Button(description='DC_color', disabled=True, layout=name_button_layout)
        ...
        param_name77 = Button(description='activated_DC_color', disabled=True, layout=name_button_layout)
        ...
        param_name78 = Button(description='fibroblast_color', disabled=True, layout=name_button_layout)
        ...
        param_name79 = Button(description='phagocytes_virus_uptake_rate', disabled=True, layout=name_button_layout)
        ...
        param_name80 = Button(description='ROS_secretion_rate', disabled=True, layout=name_button_layout)
        ...
        param_name81 = Button(description='epsilon_ROS', disabled=True, layout=name_button_layout)
        ...
        param_name82 = Button(description='Antibody_binding_rate', disabled=True, layout=name_button_layout)
        ...
        param_name83 = Button(description='antibody_half_effect', disabled=True, layout=name_button_layout)
        ...
        param_name84 = Button(description='virus_fraction_released_at_death', disabled=True, layout=name_button_layout)
        ...
        units_button3 = Button(description='micron', disabled=True, layout=units_button_layout) 
        units_button3.style.button_color = 'tan'
        units_button4 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        units_button4.style.button_color = 'lightgreen'
        units_button5 = Button(description='substrate/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button7 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button10 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button13 = Button(description='cells/min', disabled=True, layout=units_button_layout) 
        ...
        units_button44 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        units_button44.style.button_color = 'lightgreen'
        units_button45 = Button(description='substrate/micron^3', disabled=True, layout=units_button_layout) 
        units_button45.style.button_color = 'tan'
        units_button46 = Button(description='substrate/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button57 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        units_button57.style.button_color = 'lightgreen'
        units_button58 = Button(description='cells/min/micron^3', disabled=True, layout=units_button_layout) 
        ...
        units_button60 = Button(description='virions', disabled=True, layout=units_button_layout) 
        ...
        units_button62 = Button(description='percentage', disabled=True, layout=units_button_layout) 
        ...
        units_button82.style.button_color = 'lightgreen'
        units_button83 = Button(description='', disabled=True, layout=units_button_layout) 
        units_button83.style.button_color = 'tan'
        units_button84 = Button(description='', disabled=True, layout=units_button_layout) 
        units_button84.style.button_color = 'lightgreen'
        ...
        desc_button2 = Button(description='immune cell position over the epithelium' , tooltip='immune cell position over the epithelium', disabled=True, layout=desc_button_layout) 
        desc_button2.style.button_color = 'tan'
        desc_button3 = Button(description='max macrophage recruitment rate (for saturated signal)' , tooltip='max macrophage recruitment rate (for saturated signal)', disabled=True, layout=desc_button_layout) 
        desc_button3.style.button_color = 'lightgreen'
        desc_button4 = Button(description='min concentration to attract macrophages' , tooltip='min concentration to attract macrophages', disabled=True, layout=desc_button_layout) 
        desc_button4.style.button_color = 'tan'
        desc_button5 = Button(description='saturating concentration to attract macrophages' , tooltip='saturating concentration to attract macrophages', disabled=True, layout=desc_button_layout) 
        desc_button5.style.button_color = 'lightgreen'
        desc_button6 = Button(description='max neutrophil recruitment rate (for saturated signal)' , tooltip='max neutrophil recruitment rate (for saturated signal)', disabled=True, layout=desc_button_layout) 
        desc_button6.style.button_color = 'tan'
        desc_button7 = Button(description='min concentration to attract neutrophils' , tooltip='min concentration to attract neutrophils', disabled=True, layout=desc_button_layout) 
        desc_button7.style.button_color = 'lightgreen'
        desc_button8 = Button(description='saturating concentration to attract neutrophils' , tooltip='saturating concentration to attract neutrophils', disabled=True, layout=desc_button_layout) 
        desc_button8.style.button_color = 'tan'
        desc_button9 = Button(description='max DC recruitment rate (for saturated signal)' , tooltip='max DC recruitment rate (for saturated signal)', disabled=True, layout=desc_button_layout) 
        desc_button9.style.button_color = 'lightgreen'
        desc_button10 = Button(description='min concentration to attract DC' , tooltip='min concentration to attract DC', disabled=True, layout=desc_button_layout) 
        desc_button10.style.button_color = 'tan'
        desc_button11 = Button(description='saturating concentration to attract DC' , tooltip='saturating concentration to attract DC', disabled=True, layout=desc_button_layout) 
        desc_button11.style.button_color = 'lightgreen'
        desc_button12 = Button(description='TC death rate' , tooltip='TC death rate', disabled=True, layout=desc_button_layout) 
        desc_button12.style.button_color = 'tan'
        desc_button13 = Button(description='max activation TC' , tooltip='max activation TC', disabled=True, layout=desc_button_layout) 
        desc_button13.style.button_color = 'lightgreen'
        desc_button14 = Button(description='half max activation TC' , tooltip='half max activation TC', disabled=True, layout=desc_button_layout) 
        desc_button14.style.button_color = 'tan'
        desc_button15 = Button(description='max clearance TC' , tooltip='max clearance TC', disabled=True, layout=desc_button_layout) 
        desc_button15.style.button_color = 'lightgreen'
        desc_button16 = Button(description='half max clearance TC' , tooltip='half max clearance TC', disabled=True, layout=desc_button_layout) 
        desc_button16.style.button_color = 'tan'
        desc_button17 = Button(description='TC population threshold' , tooltip='TC population threshold', disabled=True, layout=desc_button_layout) 
        desc_button17.style.button_color = 'lightgreen'
        desc_button18 = Button(description='T cell recruitment factor to tissue' , tooltip='T cell recruitment factor to tissue', disabled=True, layout=desc_button_layout) 
        desc_button18.style.button_color = 'tan'
        desc_button19 = Button(description='ratio to achieve a 95% reduction in transport' , tooltip='ratio to achieve a 95% reduction in transport', disabled=True, layout=desc_button_layout) 
        desc_button19.style.button_color = 'lightgreen'
        desc_button20 = Button(description='DM decay rate' , tooltip='DM decay rate', disabled=True, layout=desc_button_layout) 
        desc_button20.style.button_color = 'tan'
        desc_button21 = Button(description='Th1 max activation speed' , tooltip='Th1 max activation speed', disabled=True, layout=desc_button_layout) 
        desc_button21.style.button_color = 'lightgreen'
        desc_button22 = Button(description='Th1 damping factor' , tooltip='Th1 damping factor', disabled=True, layout=desc_button_layout) 
        desc_button22.style.button_color = 'tan'
        desc_button23 = Button(description='Th1 active decay rate' , tooltip='Th1 active decay rate', disabled=True, layout=desc_button_layout) 
        desc_button23.style.button_color = 'lightgreen'
        desc_button24 = Button(description='Th base dacay rates' , tooltip='Th base dacay rates', disabled=True, layout=desc_button_layout) 
        desc_button24.style.button_color = 'tan'
        desc_button25 = Button(description='Th2 max self feeback speed' , tooltip='Th2 max self feeback speed', disabled=True, layout=desc_button_layout) 
        desc_button25.style.button_color = 'lightgreen'
        desc_button26 = Button(description='Th2 max conversion speed' , tooltip='Th2 max conversion speed', disabled=True, layout=desc_button_layout) 
        desc_button26.style.button_color = 'tan'
        desc_button27 = Button(description='BCell basal degradation' , tooltip='BCell basal degradation', disabled=True, layout=desc_button_layout) 
        desc_button27.style.button_color = 'lightgreen'
        desc_button28 = Button(description='BCell activation rate' , tooltip='BCell activation rate', disabled=True, layout=desc_button_layout) 
        ...
        desc_button30 = Button(description='BCell DC influenced proliferation' , tooltip='BCell DC influenced proliferation', disabled=True, layout=desc_button_layout) 
        desc_button30.style.button_color = 'tan'
        desc_button31 = Button(description='BCell proliferation Th2 wieght function' , tooltip='BCell proliferation Th2 wieght function', disabled=True, layout=desc_button_layout) 
        desc_button31.style.button_color = 'lightgreen'
        desc_button32 = Button(description='BCell damping value' , tooltip='BCell damping value', disabled=True, layout=desc_button_layout) 
        desc_button32.style.button_color = 'tan'
        desc_button33 = Button(description='PCell recuitment rate' , tooltip='PCell recuitment rate', disabled=True, layout=desc_button_layout) 
        desc_button33.style.button_color = 'lightgreen'
        desc_button34 = Button(description='PCell degradation rate' , tooltip='PCell degradation rate', disabled=True, layout=desc_button_layout) 
        desc_button34.style.button_color = 'tan'
        desc_button35 = Button(description='Ig recuitment rate' , tooltip='Ig recuitment rate', disabled=True, layout=desc_button_layout) 
        desc_button35.style.button_color = 'lightgreen'
        desc_button36 = Button(description='Ig degradation rate' , tooltip='Ig degradation rate', disabled=True, layout=desc_button_layout) 
        desc_button36.style.button_color = 'tan'
        desc_button37 = Button(description='probability of DC leaving to lymph node' , tooltip='probability of DC leaving to lymph node', disabled=True, layout=desc_button_layout) 
        desc_button37.style.button_color = 'lightgreen'
        desc_button38 = Button(description='naive TC activation rate' , tooltip='naive TC activation rate', disabled=True, layout=desc_button_layout) 
        desc_button38.style.button_color = 'tan'
        desc_button39 = Button(description='naive TC activation rate half max' , tooltip='naive TC activation rate half max', disabled=True, layout=desc_button_layout) 
        desc_button39.style.button_color = 'lightgreen'
        desc_button40 = Button(description='Th half max for cytokine feedback (inverse)' , tooltip='Th half max for cytokine feedback (inverse)', disabled=True, layout=desc_button_layout) 
        desc_button40.style.button_color = 'tan'
        desc_button41 = Button(description='value to kill T Cells post generation limit' , tooltip='value to kill T Cells post generation limit', disabled=True, layout=desc_button_layout) 
        desc_button41.style.button_color = 'lightgreen'
        desc_button42 = Button(description='lowest value to start probability draws for pyroptosis' , tooltip='lowest value to start probability draws for pyroptosis', disabled=True, layout=desc_button_layout) 
        desc_button42.style.button_color = 'tan'
        desc_button43 = Button(description='max fibroblast cell recruitment rate (for saturated signal)' , tooltip='max fibroblast cell recruitment rate (for saturated signal)', disabled=True, layout=desc_button_layout) 
        desc_button43.style.button_color = 'lightgreen'
        desc_button44 = Button(description='min concentration to attract fibroblast cells' , tooltip='min concentration to attract fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button44.style.button_color = 'tan'
        desc_button45 = Button(description='saturating concentration to attract fibroblast cells' , tooltip='saturating concentration to attract fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button45.style.button_color = 'lightgreen'
        desc_button46 = Button(description='multiplicity of infection: virions/cells at t=0' , tooltip='multiplicity of infection: virions/cells at t=0', disabled=True, layout=desc_button_layout) 
        desc_button46.style.button_color = 'tan'
        desc_button47 = Button(description='Infect center cell with one virion (overrides MOI)' , tooltip='Infect center cell with one virion (overrides MOI)', disabled=True, layout=desc_button_layout) 
        desc_button47.style.button_color = 'lightgreen'
        desc_button48 = Button(description='use a uniform distribution' , tooltip='use a uniform distribution', disabled=True, layout=desc_button_layout) 
        desc_button48.style.button_color = 'tan'
        desc_button49 = Button(description='initial number of CD8 T cells in tissue' , tooltip='initial number of CD8 T cells in tissue', disabled=True, layout=desc_button_layout) 
        desc_button49.style.button_color = 'lightgreen'
        desc_button50 = Button(description='initial number of macrophages' , tooltip='initial number of macrophages', disabled=True, layout=desc_button_layout) 
        desc_button50.style.button_color = 'tan'
        desc_button51 = Button(description='initial number of neutrophils' , tooltip='initial number of neutrophils', disabled=True, layout=desc_button_layout) 
        desc_button51.style.button_color = 'lightgreen'
        desc_button52 = Button(description='initial number of fibroblast cells' , tooltip='initial number of fibroblast cells', disabled=True, layout=desc_button_layout) 
        desc_button52.style.button_color = 'tan'
        desc_button53 = Button(description='initial number of Dendritic Cells' , tooltip='initial number of Dendritic Cells', disabled=True, layout=desc_button_layout) 
        desc_button53.style.button_color = 'lightgreen'
        desc_button54 = Button(description='initial number of CD4 Tcells in tissue' , tooltip='initial number of CD4 Tcells in tissue', disabled=True, layout=desc_button_layout) 
        desc_button54.style.button_color = 'tan'
        desc_button55 = Button(description='DC induced CD8 proliferation rate' , tooltip='DC induced CD8 proliferation rate', disabled=True, layout=desc_button_layout) 
        desc_button55.style.button_color = 'lightgreen'
        desc_button56 = Button(description='DC induced CD8 attachement rate' , tooltip='DC induced CD8 attachement rate', disabled=True, layout=desc_button_layout) 
        desc_button56.style.button_color = 'tan'
        desc_button57 = Button(description='Departure rate of activated DCs' , tooltip='Departure rate of activated DCs', disabled=True, layout=desc_button_layout) 
        desc_button57.style.button_color = 'lightgreen'
        desc_button58 = Button(description='' , tooltip='', disabled=True, layout=desc_button_layout) 
        desc_button58.style.button_color = 'tan'
        desc_button59 = Button(description='' , tooltip='', disabled=True, layout=desc_button_layout) 
        desc_button59.style.button_color = 'lightgreen'
        desc_button60 = Button(description='percentage of tissue sitting above blood vessels' , tooltip='percentage of tissue sitting above blood vessels', disabled=True, layout=desc_button_layout) 
        desc_button60.style.button_color = 'tan'
        desc_button61 = Button(description='color cells based on this variable' , tooltip='color cells based on this variable', disabled=True, layout=desc_button_layout) 
        desc_button61.style.button_color = 'lightgreen'
        desc_button62 = Button(description='opacity of epithelial cells' , tooltip='opacity of epithelial cells', disabled=True, layout=desc_button_layout) 
        desc_button62.style.button_color = 'tan'
        desc_button63 = Button(description='opacity of non-epithelial cells' , tooltip='opacity of non-epithelial cells', disabled=True, layout=desc_button_layout) 
        desc_button63.style.button_color = 'lightgreen'
        desc_button64 = Button(description='apoptotic epithelial cell color' , tooltip='apoptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button64.style.button_color = 'tan'
        desc_button65 = Button(description='apoptotic immune cell color' , tooltip='apoptotic immune cell color', disabled=True, layout=desc_button_layout) 
        desc_button65.style.button_color = 'lightgreen'
        desc_button66 = Button(description='pyroptotic epithelial cell color' , tooltip='pyroptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button66.style.button_color = 'tan'
        desc_button67 = Button(description='pyroptotic epithelial cell color' , tooltip='pyroptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button67.style.button_color = 'lightgreen'
        desc_button68 = Button(description='pyroptotic epithelial cell color' , tooltip='pyroptotic epithelial cell color', disabled=True, layout=desc_button_layout) 
        desc_button68.style.button_color = 'tan'
        desc_button69 = Button(description='CD8 T cell color' , tooltip='CD8 T cell color', disabled=True, layout=desc_button_layout) 
        desc_button69.style.button_color = 'lightgreen'
        desc_button70 = Button(description='CD4 T cell color' , tooltip='CD4 T cell color', disabled=True, layout=desc_button_layout) 
        desc_button70.style.button_color = 'tan'
        desc_button71 = Button(description='macrophage color' , tooltip='macrophage color', disabled=True, layout=desc_button_layout) 
        desc_button71.style.button_color = 'lightgreen'
        desc_button72 = Button(description='color of activated macrophage' , tooltip='color of activated macrophage', disabled=True, layout=desc_button_layout) 
        desc_button72.style.button_color = 'tan'
        desc_button73 = Button(description='color of exhausted macrophage' , tooltip='color of exhausted macrophage', disabled=True, layout=desc_button_layout) 
        desc_button73.style.button_color = 'lightgreen'
        desc_button74 = Button(description='color of hyperactivated macrophage' , tooltip='color of hyperactivated macrophage', disabled=True, layout=desc_button_layout) 
        desc_button74.style.button_color = 'tan'
        desc_button75 = Button(description='neutrophil color' , tooltip='neutrophil color', disabled=True, layout=desc_button_layout) 
        desc_button75.style.button_color = 'lightgreen'
        desc_button76 = Button(description='DC color' , tooltip='DC color', disabled=True, layout=desc_button_layout) 
        desc_button76.style.button_color = 'tan'
        desc_button77 = Button(description='DC color' , tooltip='DC color', disabled=True, layout=desc_button_layout) 
        desc_button77.style.button_color = 'lightgreen'
        desc_button78 = Button(description='fibroblast cell color' , tooltip='fibroblast cell color', disabled=True, layout=desc_button_layout) 
        desc_button78.style.button_color = 'tan'
        desc_button79 = Button(description='Rate that phagocytes uptake virus after activation' , tooltip='Rate that phagocytes uptake virus after activation', disabled=True, layout=desc_button_layout) 
        desc_button79.style.button_color = 'lightgreen'
        desc_button80 = Button(description='Rate that neutrophils secrete ROS' , tooltip='Rate that neutrophils secrete ROS', disabled=True, layout=desc_button_layout) 
        desc_button80.style.button_color = 'tan'
        desc_button81 = Button(description='ROS half-effect' , tooltip='ROS half-effect', disabled=True, layout=desc_button_layout) 
        desc_button81.style.button_color = 'lightgreen'
        desc_button82 = Button(description='Binding rate of antibody to infected cells' , tooltip='Binding rate of antibody to infected cells', disabled=True, layout=desc_button_layout) 
        desc_button82.style.button_color = 'tan'
        desc_button83 = Button(description='Half effect of antibody on macrophage phagocytosis' , tooltip='Half effect of antibody on macrophage phagocytosis', disabled=True, layout=desc_button_layout) 
        desc_button83.style.button_color = 'lightgreen'
        desc_button84 = Button(description='fraction of internal virus released at cell death' , tooltip='fraction of internal virus released at cell death', disabled=True, layout=desc_button_layout) 
        desc_button84.style.button_color = 'tan'

        row1 = [param_name1, self.random_seed, units_button1, desc_button1] 
        row2 = [param_name2, self.immune_z_offset, units_button3, desc_button2] 
        row3 = [param_name3, self.macrophage_max_recruitment_rate, units_button4, desc_button3] 
        row4 = [param_name4, self.macrophage_recruitment_min_signal, units_button5, desc_button4] 
        row5 = [param_name5, self.macrophage_recruitment_saturation_signal, units_button6, desc_button5] 
        row6 = [param_name6, self.neutrophil_max_recruitment_rate, units_button7, desc_button6] 
        row7 = [param_name7, self.neutrophil_recruitment_min_signal, units_button8, desc_button7] 
        row8 = [param_name8, self.neutrophil_recruitment_saturation_signal, units_button9, desc_button8] 
        row9 = [param_name9, self.DC_max_recruitment_rate, units_button10, desc_button9] 
        row10 = [param_name10, self.DC_recruitment_min_signal, units_button11, desc_button10] 
        row11 = [param_name11, self.DC_recruitment_saturation_signal, units_button12, desc_button11] 
        row12 = [param_name12, self.TC_death_rate, units_button13, desc_button12] 
        row13 = [param_name13, self.max_activation_TC, units_button14, desc_button13] 
        row14 = [param_name14, self.half_max_activation_TC, units_button15, desc_button14] 
        row15 = [param_name15, self.max_clearance_TC, units_button16, desc_button15] 
        row16 = [param_name16, self.half_max_clearance_TC, units_button17, desc_button16] 
        row17 = [param_name17, self.TC_population_threshold, units_button18, desc_button17] 
        row18 = [param_name18, self.T_Cell_Recruitment, units_button19, desc_button18] 
        row19 = [param_name19, self.transport_ratio, units_button20, desc_button19] 
        row20 = [param_name20, self.DM_decay, units_button21, desc_button20] 
        row21 = [param_name21, self.Th1_max_activation, units_button22, desc_button21] 
        row22 = [param_name22, self.Th1_damping, units_button23, desc_button22] 
        row23 = [param_name23, self.Th1_decay, units_button24, desc_button23] 
        row24 = [param_name24, self.Th_base_decay, units_button25, desc_button24] 
        row25 = [param_name25, self.Th2_self_feeback, units_button26, desc_button25] 
        row26 = [param_name26, self.Th2_max_conversion, units_button27, desc_button26] 
        row27 = [param_name27, self.BCell_removal, units_button28, desc_button27] 
        row28 = [param_name28, self.BCell_activation, units_button29, desc_button28] 
        row29 = [param_name29, self.BCell_activation_half, units_button30, desc_button29] 
        row30 = [param_name30, self.BCell_DC_proliferation, units_button31, desc_button30] 
        row31 = [param_name31, self.BCell_Th2_wieght_function, units_button32, desc_button31] 
        row32 = [param_name32, self.BCell_damping, units_button33, desc_button32] 
        row33 = [param_name33, self.PCell_recuitment, units_button34, desc_button33] 
        row34 = [param_name34, self.PCell_degradation, units_button35, desc_button34] 
        row35 = [param_name35, self.Ig_recuitment, units_button36, desc_button35] 
        row36 = [param_name36, self.Ig_degradation, units_button37, desc_button36] 
        row37 = [param_name37, self.DC_leave_prob, units_button38, desc_button37] 
        row38 = [param_name38, self.TC_activation, units_button39, desc_button38] 
        row39 = [param_name39, self.TC_activation_half, units_button40, desc_button39] 
        row40 = [param_name40, self.Th_half, units_button41, desc_button40] 
        row41 = [param_name41, self.Death_rates_of_old_Tcells, units_button42, desc_button41] 
        row42 = [param_name42, self.RNA_lower_bound, units_button43, desc_button42] 
        row43 = [param_name43, self.fibroblast_max_recruitment_rate, units_button44, desc_button43] 
        row44 = [param_name44, self.fibroblast_recruitment_min_signal, units_button45, desc_button44] 
        row45 = [param_name45, self.fibroblast_recruitment_saturation_signal, units_button46, desc_button45] 
        row46 = [param_name46, self.multiplicity_of_infection, units_button48, desc_button46] 
        row47 = [param_name47, self.use_single_infected_cell, units_button49, desc_button47] 
        row48 = [param_name48, self.use_uniform_dist, units_button50, desc_button48] 
        row49 = [param_name49, self.number_of_CD8_Tcells, units_button51, desc_button49] 
        row50 = [param_name50, self.number_of_macrophages, units_button52, desc_button50] 
        row51 = [param_name51, self.number_of_neutrophils, units_button53, desc_button51] 
        row52 = [param_name52, self.number_of_fibroblast, units_button54, desc_button52] 
        row53 = [param_name53, self.number_of_DCs, units_button55, desc_button53] 
        row54 = [param_name54, self.number_of_CD4_Tcells, units_button56, desc_button54] 
        row55 = [param_name55, self.DC_induced_CD8_proliferation, units_button57, desc_button55] 
        row56 = [param_name56, self.DC_induced_CD8_attachment, units_button58, desc_button56] 
        row57 = [param_name57, self.departure_rate_of_DCs, units_button59, desc_button57] 
        row58 = [param_name58, self.virions_needed_for_DC_activation, units_button60, desc_button58] 
        row59 = [param_name59, self.epsilon_distance, units_button61, desc_button59] 
        row60 = [param_name60, self.perecentage_tissue_vascularized, units_button62, desc_button60] 
        row61 = [param_name61, self.color_variable, units_button64, desc_button61] 
        row62 = [param_name62, self.epithelial_opacity, units_button65, desc_button62] 
        row63 = [param_name63, self.non_epithelial_opacity, units_button66, desc_button63] 
        row64 = [param_name64, self.apoptotic_epithelium_color, units_button67, desc_button64] 
        row65 = [param_name65, self.apoptotic_immune_color, units_button68, desc_button65] 
        row66 = [param_name66, self.pyroptotic_epithelium_color, units_button69, desc_button66] 
        row67 = [param_name67, self.pyroptotic_bystander_epithelium_color, units_button70, desc_button67] 
        row68 = [param_name68, self.vi_apoptotic_epithelium_color, units_button71, desc_button68] 
        row69 = [param_name69, self.CD8_Tcell_color, units_button72, desc_button69] 
        row70 = [param_name70, self.CD4_Tcell_color, units_button73, desc_button70] 
        row71 = [param_name71, self.Macrophage_color, units_button74, desc_button71] 
        row72 = [param_name72, self.activated_macrophage_color, units_button75, desc_button72] 
        row73 = [param_name73, self.exhausted_macrophage_color, units_button76, desc_button73] 
        row74 = [param_name74, self.hyperactivated_macrophage_color, units_button77, desc_button74] 
        row75 = [param_name75, self.Neutrophil_color, units_button78, desc_button75] 
        row76 = [param_name76, self.DC_color, units_button79, desc_button76] 
        row77 = [param_name77, self.activated_DC_color, units_button80, desc_button77] 
        row78 = [param_name78, self.fibroblast_color, units_button81, desc_button78] 
        row79 = [param_name79, self.phagocytes_virus_uptake_rate, units_button82, desc_button79] 
        row80 = [param_name80, self.ROS_secretion_rate, units_button83, desc_button80] 
        row81 = [param_name81, self.epsilon_ROS, units_button84, desc_button81] 
        row82 = [param_name82, self.Antibody_binding_rate, units_button85, desc_button82] 
        row83 = [param_name83, self.antibody_half_effect, units_button86, desc_button83] 
        row84 = [param_name84, self.virus_fraction_released_at_death, units_button87, desc_button84] 
