...
void DC_phenotype( Cell* pCell, Phenotype& phenotype, double dt )
{
	...
	else 
	{
        ...
        //rwh
		// parameters.doubles("virions_needed_for_DC_activation");
		int virions_needed_for_DC = parameters.ints("virions_needed_for_DC_activation");
		static int virus_index = microenvironment.find_density_index("virion");
		...
		if( virus_amount*microenvironment.mesh.voxels[1].volume > virions_needed_for_DC) 
		{
